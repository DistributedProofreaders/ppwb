...
<p>Please note that HTML a (link) tags must begin and end on a single line for this
to work—the beginning &lt; must be in the same row with the &gt;. Otherwise the link
test will report these as [FAIL] duplicate targets.</p>
